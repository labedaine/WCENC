...
require_once $rootDir."/collecteur/services/Autoload.php";
require_once $rootDir."/../tests/test_commun/Utils.php";

require_once $rootDir."/commun/php/services/TimeService.php";

require_once $rootDir.'/restitution/services/services/UtilisateurService.php';
require_once $rootDir.'/restitution/services/controllers/UtilisateurController.php';
require_once $rootDir.'/commun/php/framework/log_writers/FileLogWriter.php';
